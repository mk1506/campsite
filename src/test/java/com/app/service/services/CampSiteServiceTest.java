...
public class CampSiteServiceTest {
  ...
  @Mock InMemoryReservationsRepository reservationsRepositoryMock;
  ...
  public void cannotCreateReservationWithMissingInvalidDate()throws Exception{
    LocalDate nextDay = LocalDate.now().plusDays(1);
    ReservationModel reservation = new ReservationModel("1","test","test@test",nextDay,nextDay.minusDays(1));
    campSiteService.createReservation(reservation);
  ...
  public void cannotCreateReservationForOver3Days()throws Exception{
    LocalDate nextDay = LocalDate.now().plusDays(1);
    ReservationModel reservation = new ReservationModel("1","test","test@test",nextDay,nextDay.plusDays(4));
    campSiteService.createReservation(reservation);
  }
  ...
  public void cannotUpdateReservationWhenDatesReserved()throws Exception{
    ...
    String id ="1";
    ReservationModel reservationOld = new ReservationModel(id,"test","test@test",nextDay,nextDay);
    ReservationModel reservationNew = new ReservationModel(id,"test","test@test",nextDay,newReservationEnd);
  ...
  public void cannotUpdateReservationWithInvalidDate()throws Exception{
    LocalDate nextDay = LocalDate.now().plusDays(1);
    String id ="1";
    ReservationModel reservation = new ReservationModel(id,"test","test@test",nextDay,nextDay.minusDays(1));
    when(reservationsRepositoryMock.reservationExists(id)).thenReturn(true);
    campSiteService.updateReservation(id,reservation);
  }
  ...
  public void cannotUpdateReservationForOver3Days()throws Exception{
    LocalDate nextDay = LocalDate.now().plusDays(1);
    String id ="1";
    ReservationModel reservation = new ReservationModel(id,"test","test@test",nextDay,nextDay.plusDays(4));
    when(reservationsRepositoryMock.reservationExists(id)).thenReturn(true);
    campSiteService.updateReservation(id,reservation);
  }
}
